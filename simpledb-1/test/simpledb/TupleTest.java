...
//    			"RecordId.equals() not being implemented.  This is not required for assignment 1, " +
...
//    }
    ...
    @Test public void toStringTest() {
        ...
        Tuple tup = new Tuple(td);
        tup.setField(0, new IntField(1));
        tup.setField(1, new StringField("test", "test".length()));
        assertTrue("1|test".equals(tup.toString()));
    }
    /**
     * JUnit suite target
     */
